<template>
  <div class="models-page">
    <section class="hero-section">
      ...
      <!-- Black Block Section -->
      <section class="black-block-section" ref="portfolioSection" :class="{ 'animate-in': isPortfolioVisible }" @mousemove="handleMouseMove" @mouseleave="handleMouseLeave">
        <Container>
          <div class="black-block" :style="{ background: currentStage.background }" :class="{ 'transitioning': isTransitioning }">
            ...
            <div class="portfolio-arrow" ref="portfolioArrow" :class="{ 'animate-in': isPortfolioArrowVisible }" @click="nextPortfolioStage">

<template>
  <section class="black-block-section white-bg" ref="portfolioSection" :class="{ 'animate-in': isPortfolioVisible, 'fullscreen': isFullscreen }">
    <Container>
      ...
      <div class="black-block" :style="{ background: currentStage.background }" :class="{ 'transitioning': isTransitioning }" @click="toggleFullscreen">
        <MouseParallax :intensity="0.3" direction="both">
          <img :src="currentStage.image" :alt="currentStage.title" class="portfolio-image" ref="portfolioImage" :class="{ 'animate-in': isPortfolioImageVisible, 'transitioning': isTransitioning }" />
        </MouseParallax>
        <MouseParallax :intensity="0.2" direction="both">
          <h2 class="portfolio-title" ref="portfolioTitle" :class="{ 'animate-in': isPortfolioTitleVisible, 'transitioning': isTransitioning }" :style="{ color: textColor }">{{ currentStage.title }}</h2>
        </MouseParallax>
        <MouseParallax :intensity="0.2" direction="both">
          <h2 class="portfolio-title-stroke" ref="portfolioTitleStroke" :class="{ 'animate-in': isPortfolioTitleStrokeVisible, 'transitioning': isTransitioning }" :style="{ '-webkit-text-stroke': `2px ${strokeColor}` }">{{ currentStage.title }}</h2>
        </MouseParallax>
        <MouseParallax :intensity="0.4" direction="both">
          <div class="futuristic-beauty" ref="futuristicBeauty" :class="{ 'animate-in': isFuturisticBeautyVisible, 'transitioning': isTransitioning }">
...
import { MouseParallax } from './common'
